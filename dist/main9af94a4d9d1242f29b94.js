...
/* harmony import */ var _js_modules_submitForm_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js_modules/submitForm.js */ "./src/js_modules/submitForm.js");
/* harmony import */ var _js_modules_likeComment_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js_modules/likeComment.js */ "./src/js_modules/likeComment.js");
/* harmony import */ var _js_modules_deleteComment_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js_modules/deleteComment.js */ "./src/js_modules/deleteComment.js");
...
/* harmony import */ var _js_modules_showComment_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js_modules/showComment.js */ "./src/js_modules/showComment.js");
/* harmony import */ var _js_modules_validationForm_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js_modules/validationForm.js */ "./src/js_modules/validationForm.js");
/* harmony import */ var _js_modules_time_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./js_modules/time.js */ "./src/js_modules/time.js");
/* harmony import */ var _js_modules_variables_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./js_modules/variables.js */ "./src/js_modules/variables.js");
...
function setDefaultMaxDate() {
  let defaultData = _variables__WEBPACK_IMPORTED_MODULE_0__.yearNow + '-' + checkSetDefaultMaxDate(_variables__WEBPACK_IMPORTED_MODULE_0__.monthNow) + '-' + checkSetDefaultMaxDate(_variables__WEBPACK_IMPORTED_MODULE_0__.dayNow);
...
function dateConverter() {
  ...
  if (!checkDate()) {
    if (checkToday(arrCommData)) {
      ...
      return _variables__WEBPACK_IMPORTED_MODULE_0__.YESTERDAY;
    } else {
      return arrCommData[2] + "." + arrCommData[1] + "." + arrCommData[0];
    }
  }
  _variables__WEBPACK_IMPORTED_MODULE_0__.errors.push('Неправильный формат даты');
}

/***/ }),

/***/ "./src/js_modules/deleteComment.js":
/*!*****************************************!*\
  !*** ./src/js_modules/deleteComment.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				<div class="comment__block">
					...
					<div class="comment__datatime">
						<div class="comment__data">
							${(0,_data__WEBPACK_IMPORTED_MODULE_1__.dateConverter)()}
						</div>
						<div class="comment__time">${(0,_time__WEBPACK_IMPORTED_MODULE_2__.timeConverter)()}</div>
					</div>
				</div>
				<div class="comment__block">
...
/* harmony import */ var _validationForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./validationForm */ "./src/js_modules/validationForm.js");
...
_variables__WEBPACK_IMPORTED_MODULE_0__.form.onsubmit = function () {
  if (!(0,_validationForm__WEBPACK_IMPORTED_MODULE_2__.validate)()) {
    return false;
  }
...
const timeConverter = () => checkTime(_variables__WEBPACK_IMPORTED_MODULE_0__.hours) + ":" + checkTime(_variables__WEBPACK_IMPORTED_MODULE_0__.minutes);

/***/ }),

/***/ "./src/js_modules/validationForm.js":
/*!******************************************!*\
  !*** ./src/js_modules/validationForm.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function validateName() {
  if (checkLengthInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName, 5)) return false;
  if (checkEmptyInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName)) {
    addError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName, 'Заполните поле!');
    return false;
  }
  if (!checkOkInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName)) return false;
  removeError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName);
  return true;
}
_variables__WEBPACK_IMPORTED_MODULE_0__.commentName.addEventListener('blur', () => {
  if (checkLengthInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName, 5)) {
    addError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName, 'Введите больше символов!');
  }
  if (checkEmptyInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName)) {
    addError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName, 'Заполните поле!');
  }
  if (!checkOkInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName)) {
    addError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName, 'Допустимы только цифры и буквы!');
  }
});
_variables__WEBPACK_IMPORTED_MODULE_0__.commentName.addEventListener('focus', () => {
  removeError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentName);
});
function validateText() {
  if (checkLengthInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText, 10)) return false;
  if (checkEmptyInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText)) {
    addError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText, 'Заполните поле!');
    return false;
  }
  removeError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText);
  return true;
}
_variables__WEBPACK_IMPORTED_MODULE_0__.commentText.addEventListener('blur', () => {
  if (checkLengthInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText, 10)) {
    addError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText, 'Введите больше символов!');
  }
  if (checkEmptyInput(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText)) {
    addError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText, 'Заполните поле!');
  }
});
_variables__WEBPACK_IMPORTED_MODULE_0__.commentText.addEventListener('focus', () => {
  removeError(_variables__WEBPACK_IMPORTED_MODULE_0__.commentText);
});
function validate() {
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-300italic.eot */ "./src/assets/fonts/lato-v23-latin-300italic.eot"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-300italic.woff2 */ "./src/assets/fonts/lato-v23-latin-300italic.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-300italic.woff */ "./src/assets/fonts/lato-v23-latin-300italic.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-300italic.ttf */ "./src/assets/fonts/lato-v23-latin-300italic.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-300italic.svg */ "./src/assets/fonts/lato-v23-latin-300italic.svg"), __webpack_require__.b);
...
var ___CSS_LOADER_URL_IMPORT_10___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-italic.eot */ "./src/assets/fonts/lato-v23-latin-italic.eot"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_11___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-italic.woff2 */ "./src/assets/fonts/lato-v23-latin-italic.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_12___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-italic.woff */ "./src/assets/fonts/lato-v23-latin-italic.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_13___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-italic.ttf */ "./src/assets/fonts/lato-v23-latin-italic.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_14___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-italic.svg */ "./src/assets/fonts/lato-v23-latin-italic.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_15___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700.eot */ "./src/assets/fonts/lato-v23-latin-700.eot"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_16___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700.woff2 */ "./src/assets/fonts/lato-v23-latin-700.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_17___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700.woff */ "./src/assets/fonts/lato-v23-latin-700.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_18___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700.ttf */ "./src/assets/fonts/lato-v23-latin-700.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_19___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700.svg */ "./src/assets/fonts/lato-v23-latin-700.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_20___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700italic.eot */ "./src/assets/fonts/lato-v23-latin-700italic.eot"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_21___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700italic.woff2 */ "./src/assets/fonts/lato-v23-latin-700italic.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_22___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700italic.woff */ "./src/assets/fonts/lato-v23-latin-700italic.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_23___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700italic.ttf */ "./src/assets/fonts/lato-v23-latin-700italic.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_24___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/lato-v23-latin-700italic.svg */ "./src/assets/fonts/lato-v23-latin-700italic.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_25___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/img/like.svg */ "./src/assets/img/like.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_26___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/img/like-red.svg */ "./src/assets/img/like-red.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_27___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/img/delete.svg */ "./src/assets/img/delete.svg"), __webpack_require__.b);
...
var ___CSS_LOADER_URL_REPLACEMENT_29___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_3___default()(___CSS_LOADER_URL_IMPORT_24___, { hash: "#Lato" });
...
/***/ "./src/assets/fonts/lato-v23-latin-300italic.svg":
/*!*******************************************************!*\
  !*** ./src/assets/fonts/lato-v23-latin-300italic.svg ***!
  \*******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "image/lato-v23-latin-300italic.svg";
...
"use strict";
module.exports = __webpack_require__.p + "image/delete.svg";

/***/ }),

/***/ "./src/assets/img/like-red.svg":
/*!*************************************!*\
  !*** ./src/assets/img/like-red.svg ***!
  \*************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "image/like-red.svg";
...
/***/ "./src/assets/fonts/lato-v23-latin-300italic.eot":
/*!*******************************************************!*\
  !*** ./src/assets/fonts/lato-v23-latin-300italic.eot ***!
  \*******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/lato-v23-latin-300italic.eot";

/***/ }),

/***/ "./src/assets/fonts/lato-v23-latin-300italic.ttf":
/*!*******************************************************!*\
  !*** ./src/assets/fonts/lato-v23-latin-300italic.ttf ***!
  \*******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/lato-v23-latin-300italic.ttf";

/***/ }),

/***/ "./src/assets/fonts/lato-v23-latin-300italic.woff":
/*!********************************************************!*\
  !*** ./src/assets/fonts/lato-v23-latin-300italic.woff ***!
  \********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/lato-v23-latin-300italic.woff";

/***/ }),

/***/ "./src/assets/fonts/lato-v23-latin-300italic.woff2":
/*!*********************************************************!*\
  !*** ./src/assets/fonts/lato-v23-latin-300italic.woff2 ***!
  \*********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/lato-v23-latin-300italic.woff2";
...
/******/ })()
;
//# sourceMappingURL=main9af94a4d9d1242f29b94.js.map